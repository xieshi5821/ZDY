...
// 枚举 - 设定采样率
enum TVoiceRecognitionRecordSampleRateFlags
{
...
// 指定语音采样率 aSampleRate 取值 TVoiceRecognitionRecordSampleRateFlags
...
// 设置并验证开发者申请的api key和secret key，调用此方法后，不再需要调用- (void)setApiKey:(NSString *)apiKey withSecretKey:(NSString *)secretKey;
...
// 在wwan网络下，如果使用16K采样率，可以设置此标志使用amr压缩
...
// 获取语料id
- (NSString *)getServerSpeechID;

// 设置最大等待语音时间
-(void)set_max_wait_duration:(NSTimeInterval)time;
